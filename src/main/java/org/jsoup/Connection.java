...
/**
 ...
 or by methods in the {@link Request} object directly. All request configuration must be made before the request is
...
public interface Connection {
    ...
    /**
     ...
     may then be independently changed on the returned {@link Request} object).
    ...
    /**
     ...
     {@link Authenticator#setDefault(Authenticator)} method via a ThreadLocal delegator. Whilst the
